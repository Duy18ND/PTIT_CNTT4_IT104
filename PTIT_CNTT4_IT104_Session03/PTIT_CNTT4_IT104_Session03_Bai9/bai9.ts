function calculate(operater): void{
    ...
    switch(operater){
        ...
        case "/":
            if (num2 === 0) throw "Không thể chia cho 0";
            result = num1 / num2;
            break;
        ...
        case "√":
            if (num2 === 0) throw "Căn bậc 0 không hợp lệ";
            result = Math.pow(num1, 1 / num2);
            break;
            case "!":
            if (!Number.isInteger(num1) || num1 < 0) throw "Chỉ tính giai thừa cho số nguyên không âm";
            result = 1;
            for (let i = 2; i <= num1; i++) result *= i;
            break;
    }
